...
class ListCell : CBCollectionViewCell {
...
//    override var wantsUpdateLayer: Bool { return seperatorStyle == SeperatorStyle.None }
    ...
    lazy var imageView : NSImageView = {
        let iv =  NSImageView(frame: CGRect.zero)
    ...
    class func register(_ collectionView: CBCollectionView) {
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        ...
        self.backgroundColor = selected ? NSColor(white: 0, alpha: 0.1) : NSColor.clear
        self.needsDisplay = true
    }
